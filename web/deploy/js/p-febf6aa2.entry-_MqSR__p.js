import { n, V as V$1, bk as LF_COMPARE_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, bl as LF_COMPARE_PARTS, c as LF_STYLE_ID, bm as LF_COMPARE_CSS_VARS, d as LF_WRAPPER_ID, bn as LF_COMPARE_DEFAULTS, bo as LF_COMPARE_PROPS, p as pt, D as D$1, W as W$1, z as z$1, l as jt, bp as LF_COMPARE_IDS } from "./index-1OnEWJC0.js";
...
const w = (e, t, r) => {
  ...
  const { controller: r, elements: i, handlers: a2 } = t2(), { cyAttributes: s, isOverlay: o, manager: n2, parts: f2 } = r.get, { refs: c } = i, { button: h } = a2, { assignRef: p, theme: d } = n2, { columns2: u, squareToggle: b } = d.get.icons();
  return D$1("lf-button", { "data-cy": s.button, id: LF_COMPARE_IDS.changeView, lfIcon: b, lfIconOff: u, lfStyling: "icon", lfToggable: true, lfValue: !o(), "onLf-button-event": h, part: f2.changeView, ref: p(c, "changeView"), title: o() ? "Click for split screen comparison." : "Click for overlay comparison" });
}, leftButton: () => {
  const { controller: r, elements: i, handlers: a2 } = t2(), { cyAttributes: s, isOverlay: o, manager: n2, parts: f2 } = r.get, { refs: c } = i, { button: h } = a2, { assignRef: p, theme: d } = n2, u = d.get.icon("imageInPicture"), { "--lf-icon-clear": b } = d.get.current().variables;
  return D$1("lf-button", { "data-cy": s.button, id: LF_COMPARE_IDS.leftButton, lfIcon: b, lfIconOff: u, lfStyling: "icon", lfToggable: true, "onLf-button-event": h, part: f2.leftButton, ref: p(c, "leftButton"), title: o() ? "Click to open the left panel." : "Click to close the left panel." });
}, leftTree: () => {
  const { controller: r, elements: i, handlers: a2 } = t2(), { blocks: s, compInstance: o, lfAttributes: n2, manager: f2, parts: c, shapes: h } = r.get, { refs: p } = i, { tree: d } = a2, { assignRef: u, theme: b } = f2, { bemClass: m, get: g } = b, { "--lf-icon-success": v } = g.current().variables, k2 = o;
  ...
  const { controller: r, elements: i, handlers: a2 } = t2(), { cyAttributes: s, isOverlay: o, manager: n2, parts: f2 } = r.get, { refs: c } = i, { button: h } = a2, { assignRef: p, theme: d } = n2, u = d.get.icon("imageInPicture"), { "--lf-icon-clear": b } = d.get.current().variables;
  return D$1("lf-button", { "data-cy": s.button, id: LF_COMPARE_IDS.rightButton, lfIcon: b, lfIconOff: u, lfStyling: "icon", lfToggable: true, "onLf-button-event": h, part: f2.rightButton, ref: p(c, "rightButton"), title: o() ? "Click to open the right panel." : "Click to close the right panel." });
}, rightTree: () => {
  const { controller: r, elements: i, handlers: a2 } = t2(), { blocks: s, compInstance: o, lfAttributes: n2, manager: f2, parts: c, shapes: h } = r.get, { refs: p } = i, { tree: d } = a2, { assignRef: u, theme: b } = f2, { bemClass: m, get: g } = b, { "--lf-icon-success": v } = g.current().variables, k2 = o;
...
const Y = class {
  ...
  render() {
    ...
    return D$1(W$1, { key: "cc9f1f20bb0abdb7f7b10b10aef845d5a2aee034" }, s && D$1("style", { key: "c9e4154ab0d780bc06ea82bca0c3a79227d1a1fe", id: F(this, O, "f") }, r(this)), D$1("div", { key: "b429c3a036880383229e1683468c6cebef657134", id: F(this, B, "f") }, D$1("div", { key: "48d213d4ee5b26375efaa0727ed1cb2eb2f0c609", class: t(i._), part: F(this, S, "f").compare }, F(this, x, "m", A).call(this))));
  }
