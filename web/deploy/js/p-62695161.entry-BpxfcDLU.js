import { n, V, aV as LF_ARTICLE_BLOCKS, C as CY_ATTRIBUTES, aW as LF_ARTICLE_PARTS, b as LF_STYLE_ID, c as LF_WRAPPER_ID, aX as LF_ARTICLE_PROPS, p as pt, D as D$1, W as W$1, z as z$1, k as jt } from "./index-CoMIlQ4I.js";
import { a } from "./p-Dl9cVpAY-Ducg8Q9M.js";
import { r } from "./p-CKijk88y-Dzb3rxKn.js";
var g, u, p, y, b, z, w, k, x, C, E, j, W, S, D = function(t, e, i, a2) {
  ...
  return "m" === i ? a2 : "a" === i ? a2.call(t) : a2 ? a2.value : e.get(t);
};
const T = class {
  constructor(i) {
    n(this, i), this.lfEvent = V(this, "lf-article-event"), g.add(this), this.lfDataset = null, this.lfEmpty = "Empty data.", this.lfStyle = "", this.lfUiSize = "medium", u.set(this, void 0), p.set(this, LF_ARTICLE_BLOCKS), y.set(this, CY_ATTRIBUTES), b.set(this, LF_ARTICLE_PARTS), z.set(this, LF_STYLE_ID), w.set(this, LF_WRAPPER_ID);
  }
  onLfEvent(t, e) {
  ...
  render() {
    var _a;
    const { theme: t } = D(this, u, "f"), { bemClass: e, setLfStyle: i } = t, { lfDataset: l, lfEmpty: o, lfStyle: s } = this, { emptyData: n2 } = D(this, p, "f");
    return D$1(W$1, { key: "facc45a56c7f608d4ea63431396e1a044bf952cc" }, s && D$1("style", { key: "32ff6a90169431aa5dba003da5e168715cbeb1f5", id: D(this, z, "f") }, i(this)), D$1("div", { key: "c5549c09dd1786060182280c0586fee4d7c45985", id: D(this, w, "f") }, ((_a = l == null ? void 0 : l.nodes) == null ? void 0 : _a.length) ? D(this, g, "m", x).call(this) : D$1("div", { class: e(n2._), part: D(this, b, "f").emptyData }, D$1("div", { class: e(n2._, n2.text) }, o))));
  }
...
u = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), y = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), w = /* @__PURE__ */ new WeakMap(), g = /* @__PURE__ */ new WeakSet(), k = function(t, e) {
  var _a;
  switch (e) {
    case 0:
    ...
    case 2:
      return D(this, g, "m", W).call(this, t, e);
    default:
      return ((_a = t.children) == null ? void 0 : _a.length) ? D(this, g, "m", j).call(this, t, e) : D(this, g, "m", S).call(this, t, e);
  }
}, x = function() {
  const t = [], { nodes: e } = this.lfDataset;
  for (let i = 0; i < e.length; i++) {
    const a2 = e[i];
    t.push(D(this, g, "m", k).call(this, a2, 0));
  }
  return D$1(jt, null, t);
}, C = function(t, e) {
  const { bemClass: i } = D(this, u, "f").theme, { children: r2, cssStyle: l, value: s } = t;
  return D$1(jt, null, D$1("article", { class: i(D(this, p, "f").article._), "data-cy": D(this, y, "f").node, "data-depth": e.toString(), part: D(this, b, "f").article, style: l }, s && D$1("h1", null, s), r2 && t.children.map(((t2) => D(this, g, "m", k).call(this, t2, e + 1)))));
}, E = function(t, e) {
  const { bemClass: i } = D(this, u, "f").theme, { children: r2, cssStyle: l, value: s } = t;
  return D$1(jt, null, D$1("section", { class: i(D(this, p, "f").section._), "data-cy": D(this, y, "f").node, "data-depth": e.toString(), part: D(this, b, "f").section, style: l }, s && D$1("h2", null, s), r2 && r2.map(((t2) => D(this, g, "m", k).call(this, t2, e + 1)))));
}, j = function(t, e) {
  const { bemClass: i } = D(this, u, "f").theme, { children: r2, cssStyle: l, tagName: s, value: n2 } = t, f = (r2 == null ? void 0 : r2.some(((t2) => "li" === t2.tagName))) ? "ul" : s || "div";
  return D$1(jt, null, n2 && D$1("div", null, n2), D$1(f, { class: i(D(this, p, "f").content._), "data-cy": D(this, y, "f").node, "data-depth": e.toString(), part: D(this, b, "f").content, style: l }, r2 && r2.map(((t2) => D(this, g, "m", k).call(this, t2, e + 1)))));
}, W = function(t, e) {
  const { bemClass: i } = D(this, u, "f").theme, { children: r2, cssStyle: l, value: s } = t;
  return D$1(jt, null, D$1("p", { class: i(D(this, p, "f").paragraph._), "data-cy": D(this, y, "f").node, "data-depth": e.toString(), part: D(this, b, "f").paragraph, style: l }, s && D$1("h3", null, s), r2 && r2.map(((t2) => D(this, g, "m", k).call(this, t2, e + 1)))));
}, S = function(t, e) {
  const { theme: i } = D(this, u, "f"), { cells: r$1, cssStyle: l, tagName: o, value: s } = t, n2 = r$1 && Object.keys(r$1)[0], f = r$1 == null ? void 0 : r$1[n2], { content: c } = D(this, p, "f");
  if (f) return D$1(r, { cell: f, index: 0, shape: f.shape, eventDispatcher: async (t2) => this.onLfEvent(t2, "lf-event"), framework: D(this, u, "f") });
  {
    const t2 = o || "span";
    return D$1(t2, { class: i.bemClass(c._, c.body, { [t2]: Boolean(t2) }), "data-depth": e.toString(), part: D(this, b, "f").content, style: l }, s);
  }
