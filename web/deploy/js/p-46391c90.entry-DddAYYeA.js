import { o, V as V$1, aQ as LF_TOAST_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, aR as LF_TOAST_PARTS, c as LF_STYLE_ID, aS as LF_TOAST_CSS_VARIABLES, d as LF_WRAPPER_ID, U as U$1, aT as LF_TOAST_PROPS, m as mt, A, T as T$1 } from "./index-BPYlQam6.js";
import { o as o$1 } from "./p-c236cf18-C0p0BmJn.js";
var p, b, u, g, y, w, k, z, x, _ = function(t, a, o2, s) {
...
const W = class {
  constructor(s) {
    o(this, s), this.lfEvent = V$1(this, "lf-toast-event"), this.lfCloseIcon = "", this.lfCloseCallback = () => {
      this.unmount();
      ...
      const { assets: a, theme: s2 } = _(this, p), { get: e } = a, { bemClass: r } = s2, { toast: i } = _(this, b), { style: n } = e(`./assets/svg/${t ? this.lfCloseIcon : this.lfIcon}.svg`);
      return U$1("div", { class: r(i._, i.icon, { "has-actions": t }), "data-cy": _(this, u).maskedSvg, onPointerDown: t ? (t2) => this.lfCloseCallback(this, t2) : null, part: _(this, y).icon, style: n, tabIndex: t && 0 });
    });
  }
  onLfEvent(t, a) {
  ...
  async componentWillLoad() {
    if (function(t, a, o2, s, e) {
      ...
      a.set(t, o2);
    }(this, p, await o$1(this)), "" === this.lfCloseIcon) {
  ...
  render() {
    const { theme: t } = _(this, p), { bemClass: a, setLfStyle: s } = t, { toast: r } = _(this, b), { lfCloseIcon: i, lfIcon: n, lfMessage: l, lfStyle: f, lfTimer: c } = this;
    return U$1(A, { key: "316c535819de4d0069553d13546a1f265d6324d3" }, U$1("style", { key: "a60526ef82abf64a499bebd7dc0f27ccb79258b7", id: _(this, w) }, `
          :host {
            ${c ? `--${_(this, k).timer}: ${c}ms;` : ""}
          }
        ${f && s(this) || ""}`), U$1("div", { key: "0bb339c3762a0cabec2a2970508faa35264e5fb8", id: _(this, z), "data-lf": _(this, g).fadeIn }, U$1("div", { key: "ff4ed6998d5be73afbee6fa3d72659ca18ea024d", class: a(r._), "data-lf": _(this, g)[this.lfUiState] }, U$1("div", { key: "0692bba3e047c9a5defdd7feb089f82b9ba0c8e0", class: a(r._, r.accent, { temporary: !!c }) }), U$1("div", { key: "287303638535fe6070ba9d17d4247d97816a9f5b", class: a(r._, r.messageWrapper, { full: Boolean(n) && Boolean(i), "has-actions": Boolean(i), "has-icon": Boolean(n) }) }, n && _(this, x).call(this), l && U$1("div", { key: "fcb2dbae067fdfc54d8379a0c32102750f008a2c", class: a(r._, r.message) }, l), i && _(this, x).call(this, true)))));
  }
