import { o, V as V$1, ba as LF_PLACEHOLDER_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, bb as LF_PLACEHOLDER_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, bc as LF_PLACEHOLDER_PROPS, m as mt, U as U$1, A, T as T$1 } from "./index-F8Z50_1c.js";
...
const T = class {
  constructor(i) {
    o(this, i), this.lfEvent = V$1(this, "lf-placeholder-event"), v.add(this), this.isInViewport = false, this.lfIcon = "template", this.lfProps = {}, this.lfStyle = "", this.lfThreshold = 0.25, this.lfTrigger = "both", this.lfValue = "LfCard", m.set(this, void 0), b.set(this, LF_PLACEHOLDER_BLOCKS), u.set(this, CY_ATTRIBUTES), w.set(this, LF_ATTRIBUTES), y.set(this, LF_PLACEHOLDER_PARTS), g.set(this, LF_STYLE_ID), z.set(this, LF_WRAPPER_ID), k.set(this, null), x.set(this, null), W.set(this, false);
  }
  onLfEvent(e, t) {
  ...
  render() {
    const { assets: e, sanitizeProps: t, theme: i } = C(this, m, "f"), { bemClass: o2, setLfStyle: l } = i, { placeholder: n } = C(this, b, "f"), { isInViewport: f, lfValue: h, lfProps: c, lfTrigger: d, lfIcon: p, lfStyle: v2 } = this;
    let k2;
    if (Boolean("viewport" === d && f || "props" === d && c || "both" === d && c && f)) {
      ...
      k2 = U$1("lf-" + e2, { key: "700c750eb756e656a765c934e42a3ff7d35c835b", ...t(c, h), ...i2, "data-lf": LF_ATTRIBUTES.fadeIn, ref: (e3) => M(this, x, e3) });
    } else if (p) {
      const { style: t2 } = e.get(`./assets/svg/${p}.svg`);
      k2 = U$1("div", { key: "7543c4b6740b3340dc2453651c7290117946ec53", class: o2(n._, n.icon), "data-cy": C(this, u, "f").maskedSvg, "data-lf": C(this, w, "f").fadeIn, part: C(this, y, "f").icon, style: t2 });
    }
    return U$1(A, { key: "3d35b3f8ad468158880f4eea0ddff3c3d991d952" }, v2 && U$1("style", { key: "8316bc849fcb1be22017184f6deaa81605b35b7b", id: C(this, g, "f") }, l(this)), U$1("div", { key: "2553ca5c4547f006d02e52f052ea7966bff2bbe6", id: C(this, z, "f") }, U$1("div", { key: "89e0e7cb0ccc22f9bba82d6d2bd3f6a64fe8f24a", class: o2(n._), part: C(this, y, "f").placeholder }, k2)));
  }
