import { n, V, L as LF_ACCORDION_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, b as LF_ACCORDION_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, D as D$1, e as LF_ACCORDION_PROPS, p as pt, W as W$1, z as z$1 } from "./index-D2hrmd2S.js";
...
var v, m, u, g, y, w, k, x, z, _, E, W, C, M, j, T = function(r, o, i, a2) {
  ...
  return "m" === i ? a2 : "a" === i ? a2.call(r) : a2 ? a2.value : o.get(r);
}, D = function(r, o, i, a2, e) {
  if ("function" == typeof o ? r !== o || true : !o.has(r)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
  return o.set(r, i), i;
};
const S = class {
  constructor(a2) {
    n(this, a2), this.lfEvent = V(this, "lf-accordion-event"), v.add(this), this.expandedNodes = /* @__PURE__ */ new Set(), this.selectedNodes = /* @__PURE__ */ new Set(), this.lfDataset = null, this.lfRipple = true, this.lfUiSize = "medium", this.lfUiState = "primary", this.lfStyle = "", m.set(this, void 0), u.set(this, LF_ACCORDION_BLOCKS), g.set(this, CY_ATTRIBUTES), y.set(this, LF_ATTRIBUTES), w.set(this, LF_ACCORDION_PARTS), k.set(this, LF_STYLE_ID), x.set(this, LF_WRAPPER_ID), z.set(this, {}), j.set(this, ((r) => {
      const { cells: o } = r, a3 = o && Object.keys(o)[0], e = o == null ? void 0 : o[a3];
      return D$1(f, { cell: e, index: 0, shape: e.shape, eventDispatcher: async (r2) => this.onLfEvent(r2, "lf-event"), framework: T(this, m, "f") });
    }));
  }
  onLfEvent(r, o, i) {
    const { effects: a2 } = T(this, m, "f"), { lfRipple: e, rootElement: t } = this;
    "pointerdown" === o && e && a2.ripple(r, T(this, z, "f")[i.id]), this.lfEvent.emit({ comp: this, eventType: o, id: t.id, originalEvent: r });
  }
  async getDebugInfo() {
  ...
  async toggleNode(r, o) {
    const i = this.lfDataset.nodes.find(((o2) => o2.id === r));
    i && (T(this, v, "m", E).call(this, i) ? T(this, v, "m", _).call(this, i) ? this.expandedNodes.delete(i) : this.expandedNodes.add(i) : T(this, v, "m", W).call(this, i) ? this.selectedNodes.delete(i) : this.selectedNodes.add(i), T(this, v, "m", E).call(this, i) || this.onLfEvent(o || new CustomEvent("click"), "click"), this.refresh());
  }
  async unmount(r = 0) {
    setTimeout((() => {
...
m = /* @__PURE__ */ new WeakMap(), u = /* @__PURE__ */ new WeakMap(), g = /* @__PURE__ */ new WeakMap(), y = /* @__PURE__ */ new WeakMap(), w = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakSet(), _ = function(r) {
  ...
  const { assets: o, theme: a2 } = T(this, m, "f"), { style: e } = o.get(`./assets/svg/${r}.svg`), { node: t } = T(this, u, "f");
  return D$1("div", { class: a2.bemClass(t._, t.icon), "data-cy": T(this, g, "f").maskedSvg, part: T(this, w, "f").icon, style: e });
}, M = function() {
  const { bemClass: r } = T(this, m, "f").theme, { lfDataset: o } = this, a2 = [];
  for (let e = 0; e < o.nodes.length; e++) {
    const t = o.nodes[e], n2 = T(this, v, "m", _).call(this, t), l = T(this, v, "m", E).call(this, t), s = T(this, v, "m", W).call(this, t);
    a2.push(D$1("div", { class: r(T(this, u, "f").node._), "data-cy": T(this, g, "f").node, "data-lf": T(this, y, "f")[this.lfUiState] }, D$1("div", { class: r(T(this, u, "f").node._, T(this, u, "f").node.header, { expanded: l && n2, selected: !l && s }), "data-cy": !l && T(this, g, "f").button, onClick: (r2) => this.toggleNode(t.id, r2), onPointerDown: (r2) => {
      this.onLfEvent(r2, "pointerdown", t);
    }, part: T(this, w, "f").header, tabindex: "1", title: t.description }, D$1("div", { "data-cy": T(this, g, "f").rippleSurface, "data-lf": T(this, y, "f").rippleSurface, part: T(this, w, "f").rippleSurface, ref: (r2) => {
      r2 && this.lfRipple && (T(this, z, "f")[t.id] = r2);
    } }), t.icon ? T(this, v, "m", C).call(this, t.icon) : null, D$1("span", { class: r(T(this, u, "f").node._, T(this, u, "f").node.text), part: T(this, w, "f").text }, t.value), l && D$1("div", { class: r(T(this, u, "f").node._, T(this, u, "f").node.expand, { expanded: n2 }), "data-cy": T(this, g, "f").dropdownButton, "data-lf": T(this, y, "f").icon, part: T(this, w, "f").icon })), n2 && D$1("div", { class: r(T(this, u, "f").node._, T(this, u, "f").node.content, { selected: s }), "data-lf": T(this, y, "f").fadeIn, part: T(this, w, "f").content }, T(this, j, "f").call(this, t))));
  }
  return a2;
