import { n, I, P as LF_TABBAR_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, Q as LF_TABBAR_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, W as W$1, R as LF_TABBAR_PROPS, m as mt, f as L, G } from "./index-7qnEktzy.js";
import { o } from "./p-DklcdYZv-Bz5CUaWK.js";
const p = (t, r) => {
  if (t) {
...
var u, v, m, g, y, w, z, k, x, _, W, C = function(t, r, a, i) {
...
const E = class {
  constructor(i) {
    n(this, i), this.lfEvent = I(this, "lf-tabbar-event"), this.value = null, this.lfAriaLabel = "", this.lfDataset = null, this.lfNavigation = false, this.lfRipple = true, this.lfStyle = "", this.lfUiSize = "medium", this.lfUiState = "primary", this.lfValue = null, u.set(this, void 0), v.set(this, LF_TABBAR_BLOCKS), m.set(this, CY_ATTRIBUTES), g.set(this, LF_ATTRIBUTES), y.set(this, LF_TABBAR_PARTS), w.set(this, LF_STYLE_ID), z.set(this, LF_WRAPPER_ID), k.set(this, void 0), x.set(this, void 0), _.set(this, ((t) => {
      const { get: r } = C(this, u, "f").assets, { bemClass: i2 } = C(this, u, "f").theme, { tab: o2 } = C(this, v, "f"), { style: e } = r(`./assets/svg/${t.icon}.svg`);
      return W$1("div", { class: i2(o2._, o2.icon), "data-cy": C(this, m, "f").maskedSvg, style: e });
    })), W.set(this, ((t, r) => {
      const { theme: i2 } = C(this, u, "f"), { bemClass: o2 } = i2, { tab: e } = C(this, v, "f"), { lfRipple: l, value: n2 } = this, s = t === (n2 == null ? void 0 : n2.node);
      return W$1("button", { "aria-selected": s, "aria-label": (this.lfAriaLabel && t.value ? `${this.lfAriaLabel} ${t.value}` : t.value || this.lfAriaLabel || t.icon || this.rootElement.id || "tab").toString().trim(), class: o2(e._, null, { active: s }), "data-cy": C(this, m, "f").button, "data-lf": C(this, g, "f")[this.lfUiState], onClick: (a) => {
        this.onLfEvent(a, "click", r, t);
      }, onPointerDown: (a) => {
        this.onLfEvent(a, "pointerdown", r, t);
      }, part: C(this, y, "f").tab, role: "tab", tabIndex: r, title: (t == null ? void 0 : t.description) || "" }, W$1("div", { "data-cy": C(this, m, "f").rippleSurface, "data-lf": C(this, g, "f").rippleSurface, ref: (t2) => {
        t2 && l && C(this, k, "f").push(t2);
      } }), W$1("span", { class: o2(e._, e.content), "data-cy": C(this, m, "f").node }, t.icon && C(this, _, "f").call(this, t), t.value && W$1("span", { class: o2(e._, e.label) }, t.value)), W$1("span", { class: o2(e._, e.indicator, { active: s }) }, W$1("span", { class: o2(e._, e.indicatorContent, { active: true }) })));
    }));
  }
  onLfEvent(t, r, a = 0, i) {
    const { effects: o2 } = C(this, u, "f");
    switch (r) {
      case "click":
        this.value = { index: a, node: i };
        break;
      case "pointerdown":
        this.lfRipple && o2.ripple(t, C(this, k, "f")[a]);
    }
  ...
  connectedCallback() {
    C(this, u, "f") && C(this, u, "f").theme.register(this);
  }
  async componentWillLoad() {
    M(this, u, await o(this));
    const { debug: t } = C(this, u, "f"), { lfDataset: r, lfValue: a } = this;
    try {
  ...
  componentDidLoad() {
    const { debug: t, drag: r } = C(this, u, "f");
    C(this, x, "f") && r.register.dragToScroll(C(this, x, "f")), this.onLfEvent(new CustomEvent("ready"), "ready"), t.info.update(this, "did-load");
  }
  componentWillRender() {
    const { debug: t } = C(this, u, "f");
    t.info.update(this, "will-render");
  }
  componentDidRender() {
    const { info: t } = C(this, u, "f").debug;
    t.update(this, "did-render");
  }
  render() {
    const { data: t, theme: r } = C(this, u, "f"), { bemClass: i, get: e, setLfStyle: l } = r, { "--lf-icon-next": n2, "--lf-icon-previous": s } = e.current().variables, { tabbar: f } = C(this, v, "f"), { lfDataset: c, lfStyle: b } = this;
    if (!t.node.exists(c)) return;
    M(this, k, []);
    const d = c.nodes;
    return W$1(L, null, b && W$1("style", { id: C(this, w, "f") }, l(this)), W$1("div", { id: C(this, z, "f") }, W$1("div", { class: i(f._), part: C(this, y, "f").tabbbar, role: "tablist" }, this.lfNavigation && W$1("lf-button", { lfIcon: s, lfStretchY: true, lfStyling: "flat", lfUiSize: this.lfUiSize, "onLf-button-event": () => p(C(this, x, "f"), "left") }), W$1("div", { class: i(f._, f.scroll), ref: (t2) => {
      t2 && M(this, x, t2);
    } }, d.map(((t2, r2) => C(this, W, "f").call(this, t2, r2)))), this.lfNavigation && W$1("lf-button", { lfIcon: n2, lfStretchY: true, lfStyling: "flat", lfUiSize: this.lfUiSize, "onLf-button-event": () => p(C(this, x, "f"), "right") }))));
  }
  disconnectedCallback() {
    var _a, _b, _c;
    ((_a = C(this, u, "f")) == null ? void 0 : _a.drag.getActiveSession(C(this, x, "f"))) && ((_b = C(this, u, "f")) == null ? void 0 : _b.drag.unregister.dragToScroll(C(this, x, "f"))), (_c = C(this, u, "f")) == null ? void 0 : _c.theme.unregister(this);
  }
  get rootElement() {
    return G(this);
  }
