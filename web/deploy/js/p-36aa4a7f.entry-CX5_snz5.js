import { n, V, B as LF_SLIDER_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, E as LF_SLIDER_PARTS, c as LF_STYLE_ID, F as LF_SLIDER_CSS_VARIABLES, d as LF_WRAPPER_ID, G as LF_SLIDER_PROPS, p as pt, D as D$1, W as W$1, z as z$1 } from "./index-1OnEWJC0.js";
...
const C = class {
  constructor(i) {
    n(this, i), this.lfEvent = V(this, "lf-slider-event"), this.value = { display: 0, real: 0 }, this.lfLabel = "", this.lfLeadingLabel = false, this.lfMax = 100, this.lfMin = 0, this.lfStep = 1, this.lfRipple = true, this.lfStyle = "", this.lfUiSize = "medium", this.lfUiState = "primary", this.lfValue = 50, m.set(this, void 0), u.set(this, LF_SLIDER_BLOCKS), v.set(this, CY_ATTRIBUTES), g.set(this, LF_ATTRIBUTES), y.set(this, LF_SLIDER_PARTS), w.set(this, LF_STYLE_ID), k.set(this, LF_SLIDER_CSS_VARIABLES), z.set(this, LF_WRAPPER_ID), x.set(this, void 0), _.set(this, void 0), M.set(this, (() => "disabled" === this.lfUiState));
  }
  onLfEvent(r, e) {
    const { effects: i } = W(this, m);
    switch (e) {
      case "change":
  ...
  connectedCallback() {
    W(this, m) && W(this, m).theme.register(this);
  }
  async componentWillLoad() {
    E(this, m, await a(this));
    const { lfValue: r } = this;
    r && this.setValue(r);
  }
  componentDidLoad() {
    const { debug: r } = W(this, m);
    this.onLfEvent(new CustomEvent("ready"), "ready"), r.info.update(this, "did-load");
  }
  componentWillRender() {
    const { info: r } = W(this, m).debug;
  ...
  render() {
    ...
    return D$1(W$1, { key: "8f82ee6cd1dffdb81f07d1e83810bc4302fa7398" }, D$1("style", { key: "faf803d88ef839aa820e43a48d0b765039c4b0b8", id: W(this, w) }, `
            :host {
              ${W(this, k).value}: ${(p.display - f) / (n2 - f) * 100}%;
            }
          ${h && e(this) || ""}`), D$1("div", { key: "84a3d75382ba4674c87f07ed67ed8934abc812b0", id: W(this, z) }, D$1("div", { key: "4e52a29997143eb6355c643925b84d7cf8f6ef2d", class: r(i._, null, { leading: s }), part: W(this, y).formField }, D$1("div", { key: "84da6408a117b44f452e675e211e42ff49adda2f", class: r(t._, null, { "has-value": p.display > f, disabled: W(this, M).call(this) }), "data-lf": W(this, g)[this.lfUiState], part: W(this, y).slider }, D$1("input", { key: "853c7de168bda53dddc3985f8258ab1f8cd65fe0", type: "range", class: r(t._, t.nativeControl), "data-cy": W(this, v).input, disabled: W(this, M).call(this), max: n2, min: f, onBlur: (r2) => {
