import { n, V, w as LF_ARTICLE_BLOCKS, C as CY_ATTRIBUTES, x as LF_ARTICLE_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, y as LF_ARTICLE_PROPS, p as pt, D as D$1, W as W$1, z as z$1, l as jt } from "./index-1OnEWJC0.js";
...
const D = class {
  constructor(i) {
    n(this, i), this.lfEvent = V(this, "lf-article-event"), g.add(this), this.lfDataset = null, this.lfEmpty = "Empty data.", this.lfStyle = "", this.lfUiSize = "medium", u.set(this, void 0), p.set(this, LF_ARTICLE_BLOCKS), b.set(this, CY_ATTRIBUTES), y.set(this, LF_ARTICLE_PARTS), z.set(this, LF_STYLE_ID), w.set(this, LF_WRAPPER_ID);
  }
  onLfEvent(t, e) {
...
u = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakMap(), y = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), w = /* @__PURE__ */ new WeakMap(), g = /* @__PURE__ */ new WeakSet(), k = function(t, e) {
  ...
  for (let i = 0; i < e.length; i++) {
    const a2 = e[i];
    t.push(T(this, g, "m", k).call(this, a2, 0));
  }
  return D$1(jt, null, t);
}, C = function(t, e) {
  const { bemClass: i } = T(this, u, "f").theme, { children: r, cssStyle: l, value: n2 } = t;
  return D$1(jt, null, D$1("article", { class: i(T(this, p, "f").article._), "data-cy": T(this, b, "f").node, "data-depth": e.toString(), part: T(this, y, "f").article, style: l }, n2 && D$1("h1", null, n2), r && t.children.map(((t2) => T(this, g, "m", k).call(this, t2, e + 1)))));
}, E = function(t, e) {
  const { bemClass: i } = T(this, u, "f").theme, { children: r, cssStyle: l, value: n2 } = t;
  return D$1(jt, null, D$1("section", { class: i(T(this, p, "f").section._), "data-cy": T(this, b, "f").node, "data-depth": e.toString(), part: T(this, y, "f").section, style: l }, n2 && D$1("h2", null, n2), r && r.map(((t2) => T(this, g, "m", k).call(this, t2, e + 1)))));
}, W = function(t, e) {
