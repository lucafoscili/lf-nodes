import { n, V, aZ as LF_CAROUSEL_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, a_ as LF_CAROUSEL_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, a$ as LF_CAROUSEL_PROPS, p as pt, D as D$1, W as W$1, z as z$1, l as jt, b0 as LF_CAROUSEL_IDS } from "./index-1OnEWJC0.js";
...
const m = { start: (t) => {
  ...
  const { controller: s, elements: i, handlers: r } = e2(), { blocks: a2, cyAttributes: o, manager: n2, parts: c } = s.get, { assignRef: f2, theme: h } = n2, { refs: u } = i, { button: d } = r, { "--lf-icon-previous": b } = h.get.current().variables;
  return D$1("lf-button", { class: h.bemClass(a2.carousel._, a2.carousel.back), "data-cy": o.button, id: LF_CAROUSEL_IDS.back, lfIcon: b, lfStyling: "icon", lfUiSize: "large", "onLf-button-event": d, part: c.back, ref: f2(u, "back"), title: "Previous slide." });
}, forward: () => {
  const { controller: s, elements: i, handlers: r } = e2(), { blocks: a2, cyAttributes: o, manager: n2, parts: c } = s.get, { assignRef: f2, theme: h } = n2, { refs: u } = i, { button: d } = r, { "--lf-icon-next": b } = h.get.current().variables;
  return D$1("lf-button", { class: h.bemClass(a2.carousel._, a2.carousel.forward), "data-cy": o.button, id: LF_CAROUSEL_IDS.forward, lfIcon: b, lfStyling: "icon", lfUiSize: "large", "onLf-button-event": d, part: c.forward, ref: f2(u, "forward"), title: "Next slide." });
} }))(e), w = (t) => /* @__PURE__ */ ((t2) => ({ button: (e) => {
  const { eventType: s, id: i } = e.detail, { next: r, previous: a2 } = t2().controller.set.index;
  if ("click" === s) switch (i) {
...
var k, z, x, _, S, E, W, C, M, T, j, I, L, P, D, A, R, H = function(t, e, s, i) {
...
const B = class {
  constructor(t) {
    n(this, t), this.lfEvent = V(this, "lf-carousel-event"), k.add(this), this.currentIndex = 0, this.shapes = {}, this.lfDataset = null, this.lfAutoPlay = false, this.lfInterval = 3e3, this.lfLightbox = false, this.lfNavigation = false, this.lfShape = "image", this.lfStyle = "", z.set(this, void 0), x.set(this, LF_CAROUSEL_BLOCKS), _.set(this, CY_ATTRIBUTES), S.set(this, LF_ATTRIBUTES), E.set(this, LF_CAROUSEL_PARTS), W.set(this, LF_STYLE_ID), C.set(this, LF_WRAPPER_ID), M.set(this, void 0), T.set(this, void 0), j.set(this, void 0), I.set(this, (() => {
      var t2;
      Y(this, j, { controller: { get: { blocks: H(this, x, "f"), compInstance: this, cyAttributes: CY_ATTRIBUTES, index: { current: () => this.currentIndex }, interval: () => H(this, T, "f"), manager: H(this, z, "f"), parts: LF_CAROUSEL_PARTS, totalSlides: () => H(this, k, "m", L).call(this) }, set: g({ index: { current: (t3) => this.currentIndex = t3, next: () => {
        var t3, e;
      ...
      } }, interval: (t3) => Y(this, T, t3, "f") }, t2 = () => H(this, j, "f")) }, elements: { jsx: y(t2), refs: { back: null, forward: null } }, handlers: w(t2) });
    }));
  }
  onLfEvent(t, e) {
  ...
  async goToSlide(t) {
    const { current: e } = H(this, j, "f").controller.set.index;
    e(t);
  }
  async nextSlide() {
    const { next: t } = H(this, j, "f").controller.set.index;
    t();
  }
  async prevSlide() {
    const { previous: t } = H(this, j, "f").controller.set.index;
    t();
  }
  async refresh() {
    pt(this);
  ...
  async componentWillLoad() {
    Y(this, z, await a(this)), H(this, I, "f").call(this), this.updateShapes(), this.lfAutoPlay && m.start(H(this, j, "f"));
  }
  componentDidLoad() {
    const { info: t } = H(this, z, "f").debug, { register: e } = H(this, z, "f").drag, { next: s, previous: i } = H(this, j, "f").controller.set.index;
    e.swipe(H(this, M, "f"), { onEnd: (t2, e2) => {
      var _a;
  ...
  disconnectedCallback() {
    var _a, _b;
    (_a = H(this, z, "f")) == null ? void 0 : _a.drag.unregister.swipe(H(this, M, "f")), (_b = H(this, z, "f")) == null ? void 0 : _b.theme.unregister(this), m.stop(H(this, j, "f"));
  }
  get rootElement() {
    return z$1(this);
  }
...
z = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), E = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakSet(), L = function() {
  var _a, _b;
  ...
  const { bemClass: e } = H(this, z, "f").theme, { carousel: s } = H(this, x, "f"), { elements: i } = H(this, j, "f"), { jsx: r } = i, { back: a2, forward: l } = r;
  ...
  for (let a2 = 0; a2 < i; a2++) {
    ...
    r.push(D$1("div", { "aria-label": i2, class: e(s._, s.segment, { active: a2 === this.currentIndex }), "data-cy": H(this, _, "f").button, "data-index": a2, onClick: async () => this.goToSlide(a2), part: H(this, E, "f").segment, role: "button", tabIndex: 0, title: i2 }));
  }
  return D$1("div", { class: e(s._), part: H(this, E, "f").slideBar }, r);
}, R = function() {
  const { bemClass: e } = H(this, z, "f").theme, { currentIndex: s, lfShape: i } = this, { carousel: r } = H(this, x, "f"), a2 = this.shapes[i].map((() => ({ htmlProps: { dataset: { lf: H(this, S, "f").fadeIn } } }))), o = this.shapes[i][s], l = a2[s];
  return D$1("div", { class: e(r._, r.slide), "data-index": s }, D$1(f, { cell: Object.assign(l, o), index: s, shape: i, eventDispatcher: async (t) => this.onLfEvent(t, "lf-event"), framework: H(this, z, "f") }));
