import { n, I, aQ as LF_SPLASH_BLOCKS, aR as LF_SPLASH_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, aS as LF_SPLASH_PROPS, m as mt, W as W$1, f as L, G } from "./index-Cnv14yjp.js";
import { o } from "./p-DklcdYZv-DXkSjjYf.js";
var d, p, v, m, b, u = function(e, t, s, a) {
...
const g = class {
  constructor(s) {
    n(this, s), this.lfEvent = I(this, "lf-splash-event"), this.state = "initializing", this.lfLabel = "Loading...", this.lfStyle = "", d.set(this, void 0), p.set(this, LF_SPLASH_BLOCKS), v.set(this, LF_SPLASH_PARTS), m.set(this, LF_STYLE_ID), b.set(this, LF_WRAPPER_ID);
  }
  onLfEvent(e, t) {
  ...
  render() {
    const { bemClass: e, setLfStyle: t } = u(this, d).theme, { lfLabel: s, lfStyle: l, state: o2 } = this, r = "unmounting" === o2, { splash: f } = u(this, p);
    return W$1(L, { key: "b2f8e4fa5ca16c1ec0835688eaf8c8db79e004de" }, l && W$1("style", { key: "01e56d34ff2df739886396381e1d9c3ee75c44c7", id: u(this, m) }, t(this)), W$1("div", { key: "a63455f43781ab1dd0a7de874516107aeda037e4", id: u(this, b) }, W$1("div", { key: "28b288678d2c163dab061b917c84ea4b8dd8f1c1", class: e(f._, null, { active: r }), part: u(this, v).splash }, W$1("div", { key: "6939e6eff13d37bbfbf3f7c59f496c70699cd9c8", class: e(f._, f.content), part: u(this, v).content }, W$1("div", { key: "ad9c8d8d3d00c153bf1d6bbee56fae140c5c462e", class: e(f._, f.widget), part: u(this, v).widget }, W$1("slot", { key: "3b97f4a962a2a10527a568a2b935b79b43be6ca8" })), W$1("div", { key: "1e98521df8a0244361a51d011aba684d3b1fbfe1", class: e(f._, f.label), part: u(this, v).label }, r ? "Ready!" : s)))));
  }
