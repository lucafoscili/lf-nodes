import { o, V as V$1, bl as LF_SLIDER_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, bm as LF_SLIDER_PARTS, c as LF_STYLE_ID, bn as LF_SLIDER_CSS_VARIABLES, d as LF_WRAPPER_ID, bo as LF_SLIDER_PROPS, m as mt, U as U$1, A, T as T$1 } from "./index-F8Z50_1c.js";
...
const C = class {
  ...
  render() {
    const { bemClass: r, setLfStyle: e } = W(this, u).theme, { formField: i, slider: t } = W(this, m), { lfLabel: o2, lfLeadingLabel: s, lfMax: n, lfMin: f, lfRipple: d, lfStep: c, lfStyle: h, value: p } = this;
    return U$1(A, { key: "69128664c0532f37c163673a3b42ae9e8af535d3" }, U$1("style", { key: "fb7510630ef43ceb178de61f1e91abe8129f4f9c", id: W(this, w) }, `
            :host {
              ${W(this, k).value}: ${(p.display - f) / (n - f) * 100}%;
            }
          ${h && e(this) || ""}`), U$1("div", { key: "97eb886f237d4b93845d306a5fd34da0e9a415bf", id: W(this, z) }, U$1("div", { key: "a448369c92e62f196980370cc24ef2917e09e198", class: r(i._, null, { leading: s }), part: W(this, y).formField }, U$1("div", { key: "7bd48df7f38a22faa63642518c28c4efdee2835a", class: r(t._, null, { "has-value": p.display > f, disabled: W(this, M).call(this) }), "data-lf": W(this, g)[this.lfUiState], part: W(this, y).slider }, U$1("input", { key: "830f9a146ba4595e33c938e294956ca4a4d5d723", type: "range", class: r(t._, t.nativeControl), "data-cy": W(this, v).input, disabled: W(this, M).call(this), max: n, min: f, onBlur: (r2) => {
      ...
      r2 && E(this, x, r2);
    }, step: c, value: p.real }), U$1("div", { key: "dd5bdcc53525a30b084cdb614b41d31727de2863", class: r(t._, t.track) }, U$1("div", { key: "24219f112409f7e005fafa706d2079671772e97e", class: r(t._, t.thumbUnderlay) }, U$1("div", { key: "c10fe89510425e42af1137151d1a3af95d4a3be8", class: r(t._, t.thumb), "data-cy": W(this, v).rippleSurface, "data-lf": W(this, g).rippleSurface, part: W(this, y).thumb, ref: (r2) => {
      d && E(this, _, r2);
    } }))), U$1("span", { key: "b4ae6071370af64ea2d77e2131d80ed9dff336ef", class: r(t._, t.value), part: W(this, y).value }, p.display)), U$1("label", { key: "a1330dc860c441533ea2b231121896bcf4d4a5b2", class: r(i._, i.label), part: W(this, y).label }, o2))));
  }
