import { o, V as V$1, aE as LF_TABBAR_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, aF as LF_TABBAR_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, U as U$1, aG as LF_TABBAR_PROPS, m as mt, A, T as T$1 } from "./index-F8Z50_1c.js";
...
const E = class {
  constructor(i) {
    o(this, i), this.lfEvent = V$1(this, "lf-tabbar-event"), this.value = null, this.lfDataset = null, this.lfNavigation = false, this.lfRipple = true, this.lfStyle = "", this.lfUiSize = "medium", this.lfUiState = "primary", this.lfValue = null, u.set(this, void 0), v.set(this, LF_TABBAR_BLOCKS), m.set(this, CY_ATTRIBUTES), g.set(this, LF_ATTRIBUTES), y.set(this, LF_TABBAR_PARTS), w.set(this, LF_STYLE_ID), z.set(this, LF_WRAPPER_ID), k.set(this, void 0), x.set(this, void 0), _.set(this, (t) => {
      const { get: r } = M(this, u, "f").assets, { bemClass: i2 } = M(this, u, "f").theme, { tab: o2 } = M(this, v, "f"), { style: e } = r(`./assets/svg/${t.icon}.svg`);
      return U$1("div", { class: i2(o2._, o2.icon), "data-cy": M(this, m, "f").maskedSvg, style: e });
    }), W.set(this, (t, r) => {
      const { theme: i2 } = M(this, u, "f"), { bemClass: o2 } = i2, { tab: e } = M(this, v, "f"), { lfRipple: l, value: n } = this, s = t === (n == null ? void 0 : n.node);
      return U$1("button", { "aria-selected": s, class: o2(e._, null, { active: s }), "data-cy": M(this, m, "f").button, "data-lf": M(this, g, "f")[this.lfUiState], onClick: (a) => {
        this.onLfEvent(a, "click", r, t);
      }, onPointerDown: (a) => {
        this.onLfEvent(a, "pointerdown", r, t);
      }, part: M(this, y, "f").tab, role: "tab", tabIndex: r, title: (t == null ? void 0 : t.description) || "" }, U$1("div", { "data-cy": M(this, m, "f").rippleSurface, "data-lf": M(this, g, "f").rippleSurface, ref: (t2) => {
        t2 && l && M(this, k, "f").push(t2);
      } }), U$1("span", { class: o2(e._, e.content), "data-cy": M(this, m, "f").node }, t.icon && M(this, _, "f").call(this, t), t.value && U$1("span", { class: o2(e._, e.label) }, t.value)), U$1("span", { class: o2(e._, e.indicator, { active: s }) }, U$1("span", { class: o2(e._, e.indicatorContent, { active: true }) })));
    });
  }
  onLfEvent(t, r, a = 0, i) {
  ...
  render() {
    const { data: t, theme: r } = M(this, u, "f"), { bemClass: i, get: e, setLfStyle: l } = r, { "--lf-icon-next": n, "--lf-icon-previous": s } = e.current().variables, { tabbar: f } = M(this, v, "f"), { lfDataset: c, lfStyle: b } = this;
    if (!t.node.exists(c)) return;
    C(this, k, []);
    const d = c.nodes;
    return U$1(A, null, b && U$1("style", { id: M(this, w, "f") }, l(this)), U$1("div", { id: M(this, z, "f") }, U$1("div", { class: i(f._), part: M(this, y, "f").tabbbar, role: "tablist" }, this.lfNavigation && U$1("lf-button", { lfIcon: s, lfStretchY: true, lfStyling: "flat", lfUiSize: this.lfUiSize, "onLf-button-event": () => p(M(this, x, "f"), "left") }), U$1("div", { class: i(f._, f.scroll), ref: (t2) => {
      t2 && C(this, x, t2);
    } }, d.map((t2, r2) => M(this, W, "f").call(this, t2, r2))), this.lfNavigation && U$1("lf-button", { lfIcon: n, lfStretchY: true, lfStyling: "flat", lfUiSize: this.lfUiSize, "onLf-button-event": () => p(M(this, x, "f"), "right") }))));
  }
