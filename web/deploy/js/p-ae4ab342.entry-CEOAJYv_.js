import { n, H as H$1, aV as LF_IMAGEVIEWER_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, aW as LF_IMAGEVIEWER_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, aX as LF_IMAGEVIEWER_PROPS, f as de, N, U as U$1, F as F$1, aY as IDS } from "./index-Bln77JyF.js";
...
const b = async (e, t = null) => {
  ...
  if (g2) return N("lf-canvas", { class: b2(n2.detailsGrid._, n2.detailsGrid.canvas), "data-lf": o2.fadeIn, id: IDS.details.canvas, lfImageProps: { lfValue: g2.value }, "onLf-canvas-event": d, ref: u(f, "canvas") });
}, clearHistory: () => {
  var _a;
  ...
  return N("lf-button", { class: b2(n2.detailsGrid._, n2.detailsGrid.clearHistory), "data-cy": l.button, id: IDS.details.clearHistory, lfIcon: v2, lfLabel: "Clear history", lfStretchX: true, lfStyling: "flat", lfUiState: p2 ? "disabled" : "danger", "onLf-button-event": d, ref: u(f, "clearHistory") });
}, deleteShape: () => {
  ...
  return N("lf-button", { class: u(n2.detailsGrid._, n2.detailsGrid.delete), "data-cy": l.button, id: IDS.details.deleteShape, lfIcon: b2, lfLabel: "Delete image", lfStretchX: true, lfUiState: "danger", "onLf-button-event": f, ref: d(c, "deleteShape") });
}, redo: () => {
  ...
  return N("lf-button", { class: g2(n2.detailsGrid._, n2.detailsGrid.redo), "data-cy": l.button, id: IDS.details.redo, lfIcon: p2, lfLabel: "Redo", lfStretchX: true, lfStyling: "flat", lfUiState: w2 ? "disabled" : "primary", "onLf-button-event": u, ref: m(h, "redo") });
}, save: () => {
  var _a;
  ...
  return N("lf-button", { class: b2(n2.detailsGrid._, n2.detailsGrid.commitChanges), "data-cy": l.button, id: IDS.details.save, lfIcon: v2, lfLabel: "Save snapshot", lfStretchX: true, lfUiState: p2 ? "disabled" : "success", "onLf-button-event": h, ref: u(d, "save") });
}, spinner: () => {
  ...
  return N("lf-spinner", { class: d(a.detailsGrid._, a.detailsGrid.spinner), id: IDS.details.spinner, lfActive: l(), lfDimensions: "16px", lfFader: true, lfFaderTimeout: 125, lfLayout: 14, ref: c(o2, "save") });
}, tree: () => {
  ...
  return N("lf-tree", { class: m(n2.detailsGrid._, n2.detailsGrid.tree), "data-cy": o2.input, id: IDS.details.tree, lfAccordionLayout: true, lfDataset: l.lfValue, lfFilter: false, lfSelectable: true, lfUiSize: "small", "onLf-tree-event": d, ref: h(f, "tree") });
}, undo: () => {
  var _a;
  ...
  return N("lf-button", { class: g2(n2.detailsGrid._, n2.detailsGrid.undo), "data-cy": l.button, id: IDS.details.undo, lfIcon: p2, lfLabel: "Undo", lfStretchX: true, lfStyling: "flat", lfUiState: y2 ? "disabled" : "primary", "onLf-button-event": u, ref: m(h, "undo") });
} }), x = (t) => ({ load: () => {
  ...
  return N("lf-button", { class: u(n2.navigationGrid._, n2.navigationGrid.button), "data-cy": l.button, id: IDS.navigation.load, lfLabel: "Load", lfStretchX: true, "onLf-button-event": f, ref: d(c, "load") }, N("lf-spinner", { lfActive: true, lfDimensions: "2px", lfLayout: 1, slot: "spinner" }));
}, masonry: () => {
  ...
  return N("lf-masonry", { class: m(n2.navigationGrid._, n2.navigationGrid.masonry), id: IDS.navigation.masonry, lfActions: true, lfDataset: d, lfSelectable: true, "onLf-masonry-event": f, ref: h(c, "masonry") });
}, textfield: () => {
  ...
  return N("lf-textfield", { class: u(n2.navigationGrid._, n2.navigationGrid.textfield), "data-cy": l.input, id: IDS.navigation.textfield, lfIcon: "folder", lfLabel: "Directory", lfStretchX: true, lfStyling: "flat", "onLf-textfield-event": f, ref: d(c, "textfield") });
} }), k = (e) => ({ button: async (t) => {
...
var I, A, _, D, R, W, E, T, M, j, U, X, H, P, F = function(e, t, s, i) {
...
const B = class {
  constructor(e) {
    n(this, e), this.lfEvent = H$1(this, "lf-imageviewer-event"), I.add(this), this.currentShape = {}, this.history = {}, this.historyIndex = null, this.isSpinnerActive = false, this.lfDataset = {}, this.lfLoadCallback = null, this.lfStyle = "", this.lfValue = {}, A.set(this, void 0), _.set(this, LF_IMAGEVIEWER_BLOCKS), D.set(this, CY_ATTRIBUTES), R.set(this, LF_ATTRIBUTES), W.set(this, LF_IMAGEVIEWER_PARTS), E.set(this, LF_STYLE_ID), T.set(this, LF_WRAPPER_ID), M.set(this, void 0), j.set(this, () => {
      var e2;
      O(this, M, { controller: { get: { blocks: F(this, _, "f"), compInstance: this, currentShape: () => F(this, I, "m", U).call(this, this.currentShape), cyAttributes: F(this, D, "f"), history: { current: () => this.history[this.currentShape.index], currentSnapshot: () => {
  ...
  render() {
    ...
    return N(U$1, { key: "31127125ef6c2695fe8e7dc80093e4c0444fca5c" }, i && N("style", { key: "f4a2b2343b8875033d828bcbc458e204ea2d14a6", id: F(this, E, "f") }, s(this)), N("div", { key: "70d2c83ec8f6fbe2a096abf867f25b37f18dc6b4", id: F(this, T, "f") }, N("div", { key: "bd36cb78794586b39c5ed10863bc7b87c39059d2", class: t(F(this, _, "f").imageviewer._), part: F(this, W, "f").imageviewer }, F(this, I, "m", H).call(this))));
  }
...
A = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), E = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakSet(), U = function(e) {
  ...
  return N("div", { class: t(s._), part: F(this, W, "f").details }, N("div", { class: t(s._, s.preview) }, i(), o2()), N("div", { class: t(s._, s.actions) }, n2(), a(), f(), r(), l()), c(), N("div", { class: t(s._, s.settings) }, N("slot", { name: "settings" })));
}, H = function() {
  const { bemClass: t } = F(this, A, "f").theme, { currentShape: s } = F(this, M, "f").controller.get;
  return N("div", { class: t(F(this, _, "f").mainGrid._, null, { selected: !!s() }) }, F(this, I, "m", P).call(this), F(this, I, "m", X).call(this));
}, P = function() {
  const { bemClass: t } = F(this, A, "f").theme, { load: s, masonry: i, textfield: a } = F(this, M, "f").elements.jsx.navigation;
  return N("div", { class: t(F(this, _, "f").navigationGrid._), part: F(this, W, "f").navigation }, a(), s(), i());
