import { n, H as H$1, Q as LF_COMPARE_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, R as LF_COMPARE_PARTS, c as LF_STYLE_ID, S as LF_COMPARE_CSS_VARS, d as LF_WRAPPER_ID, T as LF_COMPARE_DEFAULTS, V as LF_COMPARE_PROPS, f as de, N, U, F as F$1, j as ge, W as LF_COMPARE_IDS } from "./index-Bln77JyF.js";
import { o } from "./p-BJbvgtBt-CVyVjS3d.js";
import { f } from "./p-B2nA4wTt-BJoRYv4S.js";
const w = (e, t, r) => {
  const i = { nodes: [] };
  ...
  const { controller: r, elements: i, handlers: a } = t2(), { cyAttributes: s, isOverlay: o2, manager: n2, parts: c } = r.get, { refs: f2 } = i, { button: h } = a, { assignRef: p, theme: d } = n2, { columns2: u, squareToggle: b } = d.get.icons();
  return N("lf-button", { "data-cy": s.button, id: LF_COMPARE_IDS.changeView, lfIcon: b, lfIconOff: u, lfStyling: "icon", lfToggable: true, lfValue: !o2(), "onLf-button-event": h, part: c.changeView, ref: p(f2, "changeView"), title: o2() ? "Click for split screen comparison." : "Click for overlay comparison" });
}, leftButton: () => {
  const { controller: r, elements: i, handlers: a } = t2(), { cyAttributes: s, isOverlay: o2, manager: n2, parts: c } = r.get, { refs: f2 } = i, { button: h } = a, { assignRef: p, theme: d } = n2, u = d.get.icon("imageInPicture"), { "--lf-icon-clear": b } = d.get.current().variables;
  return N("lf-button", { "data-cy": s.button, id: LF_COMPARE_IDS.leftButton, lfIcon: b, lfIconOff: u, lfStyling: "icon", lfToggable: true, "onLf-button-event": h, part: c.leftButton, ref: p(f2, "leftButton"), title: o2() ? "Click to open the left panel." : "Click to close the left panel." });
}, leftTree: () => {
  const { controller: r, elements: i, handlers: a } = t2(), { blocks: s, compInstance: o2, lfAttributes: n2, manager: c, parts: f2, shapes: h } = r.get, { refs: p } = i, { tree: d } = a, { assignRef: u, theme: b } = c, { bemClass: m, get: v } = b, { "--lf-icon-success": g } = v.current().variables, k2 = o2;
  return N("lf-tree", { class: m(s.toolbar._, s.toolbar.panel, { left: true }), "data-lf": n2.fadeIn, id: LF_COMPARE_IDS.leftTree, lfDataset: w(k2.leftShape, g, h()), lfFilter: false, "onLf-tree-event": d, part: f2.leftTree, ref: u(p, "leftTree") });
}, rightButton: () => {
  const { controller: r, elements: i, handlers: a } = t2(), { cyAttributes: s, isOverlay: o2, manager: n2, parts: c } = r.get, { refs: f2 } = i, { button: h } = a, { assignRef: p, theme: d } = n2, u = d.get.icon("imageInPicture"), { "--lf-icon-clear": b } = d.get.current().variables;
  return N("lf-button", { "data-cy": s.button, id: LF_COMPARE_IDS.rightButton, lfIcon: b, lfIconOff: u, lfStyling: "icon", lfToggable: true, "onLf-button-event": h, part: c.rightButton, ref: p(f2, "rightButton"), title: o2() ? "Click to open the right panel." : "Click to close the right panel." });
}, rightTree: () => {
  const { controller: r, elements: i, handlers: a } = t2(), { blocks: s, compInstance: o2, lfAttributes: n2, manager: c, parts: f2, shapes: h } = r.get, { refs: p } = i, { tree: d } = a, { assignRef: u, theme: b } = c, { bemClass: m, get: v } = b, { "--lf-icon-success": g } = v.current().variables, k2 = o2;
  return N("lf-tree", { class: m(s.toolbar._, s.toolbar.panel, { right: true }), "data-lf": n2.fadeIn, id: LF_COMPARE_IDS.rightTree, lfDataset: w(k2.rightShape, g, h()), lfFilter: false, "onLf-tree-event": d, part: f2.rightTree, ref: u(p, "rightTree") });
} }))(t), z = (e) => /* @__PURE__ */ ((e2) => ({ button: (t) => {
  const { eventType: r, id: i, valueAsBoolean: a } = t.detail, { set: s } = e2().controller, { leftButton: o2, changeView: n2, rightButton: c } = LF_COMPARE_IDS;
  if ("click" === r) switch (i) {
    case o2:
      s.leftPanelOpened(a);
      break;
  ...
  const { eventType: r, id: i, node: a } = t.detail, { get: s, set: o2 } = e2().controller, { shapes: n2 } = s, { leftTree: c, rightTree: f2 } = LF_COMPARE_IDS;
  if ("click" === r) {
...
var x, T, _, C, I, S, B, O, W, L, E, M, j, P, A, D, R, V, F = function(e, t, r, i) {
...
const $ = class {
  constructor(e) {
    n(this, e), this.lfEvent = H$1(this, "lf-compare-event"), x.add(this), this.isLeftPanelOpened = false, this.isRightPanelOpened = false, this.shapes = {}, this.lfDataset = null, this.lfShape = "image", this.lfStyle = "", this.lfView = "main", T.set(this, void 0), _.set(this, LF_COMPARE_BLOCKS), C.set(this, CY_ATTRIBUTES), I.set(this, LF_ATTRIBUTES), S.set(this, LF_COMPARE_PARTS), B.set(this, LF_STYLE_ID), O.set(this, LF_COMPARE_CSS_VARS), W.set(this, LF_WRAPPER_ID), L.set(this, void 0), E.set(this, () => {
      var e2, t, r;
      H(this, L, (e2 = { blocks: F(this, _, "f"), compInstance: this, cyAttributes: F(this, C, "f"), isOverlay: () => F(this, x, "m", P).call(this), lfAttributes: F(this, I, "f"), manager: F(this, T, "f"), parts: F(this, S, "f"), shapes: () => F(this, x, "m", M).call(this) }, t = { leftPanelOpened: (e3) => {
      ...
      if (t instanceof HTMLInputElement) {
        ...
        this.rootElement.style.setProperty(F(this, O, "f").overlayWidth, `${e3}%`);
      }
    });
  }
  onLfEvent(e, t) {
  ...
  async componentWillLoad() {
    H(this, T, await o(this)), F(this, E, "f").call(this), this.updateShapes();
  }
  componentDidLoad() {
  ...
  render() {
    ...
    return N(U, { key: "ea73e8d15207f492eb2d3a107a239481c0f40ce0" }, s && N("style", { key: "cd91b19576b0e818d31758975cf003d410823728", id: F(this, B, "f") }, r(this)), N("div", { key: "c10e9b1c2b198ac3bc82b7cbb80608c224b71bcd", id: F(this, W, "f") }, N("div", { key: "d758cb449daaa602ec16c4c03cc03e8143a20c3d", class: t(i._), part: F(this, S, "f").compare }, F(this, x, "m", A).call(this))));
  }
...
T = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), E = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakSet(), M = function() {
  var _a;
  ...
  return N(ge, null, N("div", { class: i(a._, null, { [d]: true }) }, N("div", { class: i(a._, a.left) }, N(f, { cell: Object.assign(v, u), index: 0, shape: p, eventDispatcher: async (e) => this.onLfEvent(e, "lf-event"), framework: F(this, T, "f") })), f$1 && n2(), h && c(), F(this, x, "m", P).call(this) && N("div", { class: i(a._, a.slider), onChange: F(this, V, "f"), onInput: F(this, V, "f") }, N("input", { class: i(a._, a.input), "data-cy": F(this, C, "f").input, min: "0", max: "100", type: "range", value: "50" })), N("div", { class: i(a._, a.right) }, N(f, { cell: Object.assign(k2, b), index: 1, shape: p, eventDispatcher: async (e) => this.onLfEvent(e, "lf-event"), framework: F(this, T, "f") }))));
