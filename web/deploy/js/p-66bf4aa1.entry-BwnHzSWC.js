import { o, V as V$1, aX as LF_SPLASH_BLOCKS, aY as LF_SPLASH_PARTS, c as LF_STYLE_ID, d as LF_WRAPPER_ID, aZ as LF_SPLASH_PROPS, m as mt, U as U$1, A, T as T$1 } from "./index-B1x5QnbI.js";
...
const g = class {
  constructor(s) {
    o(this, s), this.lfEvent = V$1(this, "lf-splash-event"), this.state = "initializing", this.lfLabel = "Loading...", this.lfStyle = "", d.set(this, void 0), p.set(this, LF_SPLASH_BLOCKS), v.set(this, LF_SPLASH_PARTS), b.set(this, LF_STYLE_ID), m.set(this, LF_WRAPPER_ID);
  }
  onLfEvent(e, t) {
  ...
  render() {
    const { bemClass: e, setLfStyle: t } = u(this, d).theme, { lfLabel: s, lfStyle: l, state: o2 } = this, n = "unmounting" === o2, { splash: r } = u(this, p);
    return U$1(A, { key: "e619f4a2c71887611835bab6e1f29ab1b40f95dc" }, l && U$1("style", { key: "817187da88c539d3c04c06c32ecebacf6fb19985", id: u(this, b) }, t(this)), U$1("div", { key: "a56de9a50ff252b4fdeb268c7e2b1f14df17bfbd", id: u(this, m) }, U$1("div", { key: "5e08e82f209309804f7eeccd106c74858446ab66", class: e(r._, null, { active: n }), part: u(this, v).splash }, U$1("div", { key: "43ea78e1ccf20bd60c948a9eb146c09ae02eb323", class: e(r._, r.content), part: u(this, v).content }, U$1("div", { key: "81545c9d4a837a4651548b27fba534e6eca877e0", class: e(r._, r.widget), part: u(this, v).widget }, U$1("slot", { key: "9a0ed96228ec9763565d4efa85b93137b458b275" })), U$1("div", { key: "fe84f2cb00402811dff4d89ee1bd88748512f0e3", class: e(r._, r.label), part: u(this, v).label }, n ? "Ready!" : s)))));
  }
