import { n, I, be as LF_SLIDER_BLOCKS, C as CY_ATTRIBUTES, a as LF_ATTRIBUTES, bf as LF_SLIDER_PARTS, c as LF_STYLE_ID, bg as LF_SLIDER_CSS_VARIABLES, d as LF_WRAPPER_ID, bh as LF_SLIDER_PROPS, m as mt, W as W$1, f as L, G } from "./index-DYnTf4U4.js";
...
const C = class {
  ...
  render() {
    ...
    return W$1(L, { key: "8f82ee6cd1dffdb81f07d1e83810bc4302fa7398" }, W$1("style", { key: "faf803d88ef839aa820e43a48d0b765039c4b0b8", id: W(this, w) }, `
            :host {
              ${W(this, k).value}: ${(p.display - f) / (n2 - f) * 100}%;
            }
          ${h && e(this) || ""}`), W$1("div", { key: "84a3d75382ba4674c87f07ed67ed8934abc812b0", id: W(this, z) }, W$1("div", { key: "4e52a29997143eb6355c643925b84d7cf8f6ef2d", class: r(i._, null, { leading: s }), part: W(this, y).formField }, W$1("div", { key: "84da6408a117b44f452e675e211e42ff49adda2f", class: r(t._, null, { "has-value": p.display > f, disabled: W(this, M).call(this) }), "data-lf": W(this, g)[this.lfUiState], part: W(this, y).slider }, W$1("input", { key: "853c7de168bda53dddc3985f8258ab1f8cd65fe0", type: "range", class: r(t._, t.nativeControl), "data-cy": W(this, v).input, disabled: W(this, M).call(this), max: n2, min: f, onBlur: (r2) => {
      ...
      r2 && E(this, x, r2);
    }, step: c, value: p.real }), W$1("div", { key: "54c390ac3f085b0183de9439e5b98a95d388025f", class: r(t._, t.track) }, W$1("div", { key: "9d40003e9a5282121c81a134f0f244c89fe5c587", class: r(t._, t.thumbUnderlay) }, W$1("div", { key: "3434a7859bb8aa2fc1c5974a7cbcce20d9b8899c", class: r(t._, t.thumb), "data-cy": W(this, v).rippleSurface, "data-lf": W(this, g).rippleSurface, part: W(this, y).thumb, ref: (r2) => {
      d && E(this, _, r2);
    } }))), W$1("span", { key: "b9bb3173b021053ed83ac20add992b32d0206aff", class: r(t._, t.value), part: W(this, y).value }, p.display)), W$1("label", { key: "bab064df0606e7d0c6fe874bb92784f6451b0357", class: r(i._, i.label), part: W(this, y).label }, o2))));
  }
