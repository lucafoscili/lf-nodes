...
const v = (e) => /* @__PURE__ */ ((e2) => ({ addColumn: () => {
  ...
  const { controller: s, elements: i, handlers: a2 } = e2(), { refs: r } = i, { button: n2 } = a2, { blocks: l, cyAttributes: f2, lfAttributes: h, manager: c, parts: d } = s.get, { assignRef: m, theme: u } = c, { bemClass: p, get: g } = u, { "--lf-icon-minus": y } = g.current().variables;
  return D$1("lf-button", { class: p(l.grid._, l.grid.removeColumn), "data-cy": f2.button, "data-lf": h.fadeIn, id: LF_MASONRY_IDS.removeColumn, key: LF_MASONRY_IDS.removeColumn, lfIcon: y, lfStyling: "floating", lfUiSize: "xxsmall", "onLf-button-event": n2, part: d.removeColumn, ref: m(r, "removeColumn"), title: "Click to remove a column from the masonry." });
}, changeView: () => {
  const { controller: s, elements: i, handlers: a2 } = e2(), { refs: r } = i, { blocks: n2, cyAttributes: l, isMasonry: f2, isVertical: h, manager: c, parts: d } = s.get, { button: m } = a2, { assignRef: u, theme: p } = c, { bemClass: g, get: y } = p, { layoutBoardSplit: b, viewportTall: v2, viewportWide: w2 } = y.icons();
  return D$1("lf-button", { class: g(n2.grid._, n2.grid.changeViewe), "data-cy": l.button, id: LF_MASONRY_IDS.masonry, key: LF_MASONRY_IDS.masonry, lfIcon: f2() ? v2 : h() ? w2 : b, lfStyling: "floating", lfUiSize: "xsmall", "onLf-button-event": m, part: d.changeView, ref: u(r, "changeView"), title: f2() ? "Click to view the images arranged vertically." : h() ? "Click to view the images arranged horizontally." : "Click to view the images arranged in a masonry." });
  ...
  if ("click" === s) switch (i) {
    ...
    case LF_MASONRY_IDS.removeColumn:
      (async (t3) => {
        const { get: e2 } = t3.controller, { compInstance: s2, currentColumns: i2 } = e2, a2 = s2, r = i2();
        r > 1 && (a2.lfColumns = r - 1);
      })(t2());
      break;
...
var k, z, x, C, S, M, W, _, A, T, E, I, j, V, L, D, P, R, U, B, H, O, Y, F, K = function(t, e, s, i) {
...
const q = class {
  constructor(a2) {
    n(this, a2), this.lfEvent = V$1(this, "lf-masonry-event"), k.add(this), this.selectedShape = {}, this.shapes = {}, this.lfActions = false, this.lfColumns = Array.from(LF_MASONRY_DEFAULT_COLUMNS), this.lfDataset = null, this.lfSelectable = false, this.lfShape = "image", this.lfStyle = "", this.lfView = "main", z.set(this, void 0), x.set(this, LF_MASONRY_BLOCKS), C.set(this, CY_ATTRIBUTES), S.set(this, LF_ATTRIBUTES), M.set(this, LF_MASONRY_PARTS), W.set(this, LF_STYLE_ID), _.set(this, LF_MASONRY_CSS_VARS), A.set(this, LF_WRAPPER_ID), T.set(this, void 0), E.set(this, void 0), I.set(this, void 0), j.set(this, (() => {
      var t;
      $(this, I, { controller: { get: { blocks: K(this, x, "f"), compInstance: this, currentColumns: () => K(this, T, "f"), cyAttributes: K(this, C, "f"), isMasonry: () => K(this, L, "f").call(this), isVertical: () => K(this, D, "f").call(this), lfAttributes: K(this, S, "f"), manager: K(this, z, "f"), parts: K(this, M, "f"), shapes: () => this.shapes } }, elements: { jsx: v(t = () => K(this, I, "f")), refs: { addColumn: null, removeColumn: null, changeView: null } }, handlers: w(t) });
    })), V.set(this, (() => {
      var _a;
      ...
      clearTimeout(K(this, E, "f")), $(this, E, setTimeout(t, e));
    })), R.set(this, ((t) => t.every(((t2, e, s) => 0 === e || s[e - 1] < t2)))), B.set(this, (() => {
      const { lfShape: e, selectedShape: s, shapes: i } = this, a3 = i[this.lfShape].map((() => ({ htmlProps: { dataset: { lf: K(this, S, "f").fadeIn, selected: "" } } })));
      void 0 !== s.index && (a3[s.index] = { htmlProps: { dataset: { lf: K(this, S, "f").fadeIn, selected: "true" } } });
      const r = Array.from({ length: K(this, T, "f") }, (() => []), []);
      for (let s2 = 0; s2 < i[e].length; s2++) {
        const n2 = i[e][s2], o = a3[s2];
        r[s2 % K(this, T, "f")].push(D$1(f, { cell: Object.assign(o, n2), index: s2, shape: e, eventDispatcher: async (t) => this.onLfEvent(t, "lf-event"), framework: K(this, z, "f") }));
      }
      return r;
    })), H.set(this, K(this, P, "f").call(this, (() => {
      this.viewportWidth = window.innerWidth;
    }), 200)), O.set(this, (() => {
      const { bemClass: e } = K(this, z, "f").theme, { grid: s } = K(this, x, "f"), { addColumn: i, changeView: a3, removeColumn: r } = K(this, I, "f").elements.jsx;
      return D$1("div", { class: e(s._, s.actions), "data-lf": K(this, S, "f").fadeIn }, K(this, L, "f").call(this) && D$1("div", { class: e(s._, s.sub) }, i(), r()), a3());
    })), Y.set(this, (() => {
      const { bemClass: e } = K(this, z, "f").theme, { grid: s } = K(this, x, "f");
      return K(this, B, "f").call(this).map(((a3, r) => D$1("div", { key: r, class: e(s._, s.column) }, a3.map(((e2) => D$1(jt, null, e2))))));
    })), F.set(this, (() => {
      var _a;
      const { bemClass: e } = K(this, z, "f").theme, { grid: s } = K(this, x, "f"), { lfActions: a3, lfShape: r, lfView: n2, shapes: o } = this;
      return K(this, V, "f").call(this) && ((_a = o[r]) == null ? void 0 : _a.length) ? D$1(jt, null, D$1("div", { class: e(s._, null, { [n2]: true }) }, K(this, Y, "f").call(this)), a3 && K(this, O, "f").call(this)) : null;
    }));
  }
  onLfEvent(t, e) {
    const { lfSelectable: s, lfShape: i, selectedShape: a2, shapes: r } = this;
    let n2 = false;
    const o = {};
    if ("lf-event" === e) {
      ...
      if ("click" === l && s) {
        ...
        a2.index !== t2 && (o.index = t2, o.shape = r[i][t2]), n2 = true;
      }
    }
  ...
  validateColumns() {
    if (!K(this, z, "f")) return;
    const { debug: t } = K(this, z, "f");
    Array.isArray(this.lfColumns) && !K(this, R, "f").call(this, this.lfColumns) && (t.logs.new(this, "Invalid breakpoints in lfColumns: must be sorted in ascending order.", "warning"), this.lfColumns = [...LF_MASONRY_DEFAULT_COLUMNS]);
  }
  async updateShapes() {
    if (!K(this, z, "f")) return;
    const { data: t, debug: e } = K(this, z, "f");
    try {
  ...
  async setSelectedShape(t) {
    var _a, _b;
    const { debug: e } = K(this, z, "f"), s = (_b = (_a = this.shapes) == null ? void 0 : _a[this.lfShape]) == null ? void 0 : _b[t];
  ...
  connectedCallback() {
    K(this, z, "f") && K(this, z, "f").theme.register(this);
  }
  async componentWillLoad() {
    $(this, z, await a(this)), K(this, j, "f").call(this), this.updateShapes();
  }
  componentDidLoad() {
    window.addEventListener("resize", K(this, H, "f")), this.viewportWidth = window.innerWidth;
    const { info: t } = K(this, z, "f").debug;
    this.onLfEvent(new CustomEvent("ready"), "ready"), t.update(this, "did-load");
  }
  componentWillRender() {
    const { info: t } = K(this, z, "f").debug;
    $(this, T, K(this, L, "f").call(this) ? K(this, k, "m", U).call(this) : 1), t.update(this, "will-render");
  }
  componentDidRender() {
    const { info: t } = K(this, z, "f").debug;
  ...
  disconnectedCallback() {
    var _a;
    (_a = K(this, z, "f")) == null ? void 0 : _a.theme.unregister(this), window.removeEventListener("resize", K(this, H, "f"));
  }
  get rootElement() {
    return z$1(this);
  }
...
z = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), A = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), E = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakSet(), U = function() {
  var _a, _b;
  const { lfColumns: t, viewportWidth: e, shapes: s, lfShape: i } = this;
  if (!K(this, V, "f").call(this)) return 1;
  if ("number" == typeof t) return Math.min(t, ((_a = s[i]) == null ? void 0 : _a.length) || 0);
  if (Array.isArray(t)) {
    const a2 = t;
    let r = 1;
    for (let t2 = 0; t2 < a2.length && e >= a2[t2]; t2++) r = t2 + 1;
