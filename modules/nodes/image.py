...
# region LF_PromptToMask
class LF_PromptToMask:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
                "processor": ("*", {
                    "tooltip": "CLIPSegProcessor from LF_LoadCLIPSeg"
                }),
                "model":     ("*", {
                    "tooltip": "CLIPSegForImageSegmentation from LF_LoadCLIPSeg"
                }),
                "image": (Input.IMAGE, {
    ...
    def on_exec(self, **kwargs):
        ...
        mode = normalize_list_to_value(kwargs.get("threshold_mode", "fixed"))
...
NODE_CLASS_MAPPINGS = {
    ...
    "LF_PromptToMask": LF_PromptToMask,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "LF_PromptToMask": "Prompt to mask",
