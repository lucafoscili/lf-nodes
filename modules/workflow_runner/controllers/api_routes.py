...
"""Lightweight local constant to avoid importing heavy global constants at
module import time. Importing `...utils.constants` pulls in large comfy
submodules (which can trigger Torch/CUDA checks) and causes this controller
to fail to import during startup. Use a local literal here to keep route
