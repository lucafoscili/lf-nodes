...
_SETTINGS = Settings(
    ...
    COMFY_BACKEND_URL=str_env("COMFY_BACKEND_URL", "http://127.0.0.1:8188"),
    ...
    # Durable Runner history is the product default. Operators may opt into
    # terminal-row retention with a positive TTL; zero disables auto-delete.
    JOB_TTL_SECONDS=int_env("JOB_TTL_SECONDS", 0),
